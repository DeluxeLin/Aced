...
public class AcedContainers {
    ...
    public static final RegistryObject<MenuType<DeathInheritContainer>> DEATH_INHERIT_MENU = MENUS.register("death_inherit", () -> IForgeMenuType.create((windowId, inv, data) -> new DeathInheritContainer(windowId, inv)));
}
